        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={openModal}
                className=" cursor-pointer inline-flex items-center rounded-full bg-indigo-600 px-5 py-3 text-base font-semibold text-white transition hover:bg-indigo-700"
              >
                + Add More Campaign
              </button>
            </div>
                    ...
                    <tr key={campaign._id} className="border-t border-zinc-100 hover:bg-zinc-50 dark:border-zinc-800 dark:hover:bg-zinc-950">
                      ...
                      <td className="px-6 py-4">
                        <Link
                          ...
                          className=" cursor-pointer inline-flex items-center rounded-full border border-indigo-200 bg-indigo-50 px-3 py-2 text-sm font-semibold text-indigo-700 transition hover:bg-indigo-100 dark:border-indigo-800 dark:bg-indigo-900/40 dark:text-indigo-200"
                        >
                          View More
                        </Link>
                      </td>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-4">
          <div className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-3xl border border-zinc-200 bg-white shadow-2xl dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <div className="sticky top-0 z-10 flex items-center justify-between border-b border-zinc-100 bg-white px-6 py-4 dark:border-zinc-800 dark:bg-zinc-900">
              ...
              <button onClick={closeModal} className=" cursor-pointer rounded-full p-2 text-zinc-400 transition hover:bg-zinc-100 hover:text-zinc-600 dark:hover:bg-zinc-800">
                ✕
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="grid gap-4 p-6 lg:grid-cols-2">
              ...
              {formError && (
                <p className="lg:col-span-2 rounded-2xl bg-red-50 px-4 py-3 text-base text-red-600 dark:bg-red-950/40 dark:text-red-400">
                  {formError}
                </p>
              )}
              {formSuccess && (
                <p className="lg:col-span-2 rounded-2xl bg-emerald-50 px-4 py-3 text-base text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-400">
                  {formSuccess}
                </p>
              )}
              ...
              <div className="lg:col-span-2 flex justify-end gap-3 pt-2">
                <button type="button" onClick={closeModal}
                  className="cursor-pointer inline-flex items-center rounded-full border border-zinc-200 bg-white px-5 py-3 text-base font-semibold text-zinc-700 transition hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-200">
                  Cancel
                </button>
                <button type="submit" disabled={submitting}
                  className=" cursor-pointer inline-flex items-center rounded-full bg-indigo-600 px-6 py-3 text-base font-semibold text-white transition hover:bg-indigo-700 disabled:opacity-60">
