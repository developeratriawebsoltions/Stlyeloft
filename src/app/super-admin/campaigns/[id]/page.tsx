...
type ShareStatus = "idle" | "saving" | "success" | "error";
...
export default function CampaignDetailPage() {
    ...
    async function load() {
      ...
      try {
        const [c, i] = await Promise.all([
          ...
          fetch(`/api/campaigns/images?campaignId=${id}`),
        ]);
  ...
  async function handleUpload(e: React.FormEvent) {
    ...
    try {
      ...
      fd.append("campaignId", id as string);
  ...
  // Open password modal first, then edit modal
          ...
          <table className="min-w-full border-separate border-spacing-0 text-base">
            <thead>
              <tr className="bg-indigo-600 text-white">
                {["Campaign Name", "Start Date", "End Date", "Type", "Image", "Dimension", "Actions"].map((h) => (
              ...
              {images.length === 0 ? (
                ...
                paginatedImages.map((img, i) => (
                  <tr key={img._id} className={i % 2 === 0 ? "bg-white dark:bg-zinc-900" : "bg-zinc-50 dark:bg-zinc-950"}>
                    ...
                    <td className="px-5 py-4">
                      <button onClick={() => openEdit(img)} className=" cursor-pointer rounded-lg bg-indigo-600 px-4 py-2 text-base font-semibold text-white hover:bg-indigo-700">
                        Edit
                      </button>
                    </td>
                  </tr>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
          <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-xl dark:bg-zinc-900">
            ...
            <form onSubmit={handleVerifyPassword} className="flex flex-col gap-3">
              ...
              <button type="submit" disabled={!passwordInput || verifying} className=" cursor-pointer rounded-lg bg-indigo-600 py-2.5 text-base font-semibold text-white hover:bg-indigo-700 disabled:opacity-50">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
          <div className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-xl dark:bg-zinc-900 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleUpload} className="flex flex-col gap-3">
              <label className="flex cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-zinc-300 bg-zinc-50 py-6 hover:border-indigo-500 dark:border-zinc-700 dark:bg-zinc-950">
                {preview ? (
              ...
              <button type="submit" disabled={!selectedFile || uploading} className="mt-2 rounded-lg bg-indigo-600 py-2.5 text-base font-semibold text-white hover:bg-indigo-700 disabled:opacity-50">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
          <div className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-xl dark:bg-zinc-900 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSaveEdit} className="flex flex-col gap-3">
              <label className="flex cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-zinc-300 bg-zinc-50 py-4 hover:border-indigo-500 dark:border-zinc-700 dark:bg-zinc-950">
              ...
              <button type="submit" disabled={saving} className="mt-2 rounded-lg bg-indigo-600 py-2.5 text-sm font-semibold text-white hover:bg-indigo-700 disabled:opacity-50">
